...
In the **OAuth2** > **URL Generator** or **Redirects** section:
...
|-------------------|--------------------------------------------------------------------------------|-----------------------------------------------|--------------|
| MADDEN_SCHEDULE   | `stageIndex` (asc), `weekIndex` (asc), `seasonIndex` (desc), `__name__` (desc) | Ascending, Ascending, Descending, Descending   | Collection   |
| MADDEN_SCHEDULE   | `seasonIndex` (asc), `stageIndex` (asc), `weekIndex` (asc), `timestamp` (desc), `__name__` (desc) | Ascending, Ascending, Ascending, Descending, Descending | Collection   |
| MADDEN_SCHEDULE   | `stageIndex` (asc), `weekIndex` (asc), `timestamp` (desc), `__name__` (desc)   | Ascending, Ascending, Descending, Descending   | Collection   |
